...
import static fr.univtln.mgajovski482.D12.ViewGroup.ViewGroupUsefulFct.importFont;
...
public final class ViewGroupStyle {
    ...
    public static final  Font       DEFAULT_FONT = importFont(Default_Consts.FONT_URL + "QUARTZO.ttf");
